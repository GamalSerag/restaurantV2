...
from .views import AdminRestaurantDetailView, CategoriesView, MenuItemCreateView, MenuItemDetailView, MenuItemUpdateView,RestaurantListViewByCity, RestaurantListView, RestaurantDetailView, CityCategoriesView
urlpatterns = [
